...
class SeasonsControllerTest < ActionController::TestCase
  ...
  test "should create season" do
    assert_difference('Season.count') do
      post :create, season: { season_end: @season.season_end, season_name: @season.season_name, season_start: @season.season_start }
    end
  ...
  test "should update season" do
    put :update, id: @season, season: { season_end: @season.season_end, season_name: @season.season_name, season_start: @season.season_start }
    assert_redirected_to season_path(assigns(:season))
  end
